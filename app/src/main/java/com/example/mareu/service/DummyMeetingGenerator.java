...
public abstract class DummyMeetingGenerator {
    ...
    private static final DateTime startTime1 = new DateTime(2022,8,25,16,00);
    private static final DateTime endTime1 = new DateTime(2022,8,25,17,00);
    private static final DateTime startTime2 = new DateTime(2022,8,15,16,00);
    private static final DateTime endTime2 = new DateTime(2022,8,15,18,00);
    private static final DateTime startTime3 = new DateTime(2022,7,5,9,00);
    private static final DateTime endTime3 = new DateTime(2022,7,5,10,00);
    ...
    public static List<Meeting> DUMMY_METINGS = Arrays.asList

            (       new     Meeting(0, "Réunion 1", "user1@user.fr, user2@user.fr, user3@user.fr", startTime1,
                            endTime1, new Room(0, "Pegasus")),
                    new

                            Meeting(1, "Réunion 2", "user4@user.fr, user5@user.fr", startTime2,
                            endTime2, new Room(1, "Paintsilvia")),
                    new

                            Meeting(2, "Réunion 3", "user6@user.fr", startTime3,
                            endTime3, new Room(2, "Vulton")),
                    new

                            Meeting(3, "Réunion 4", "user11@user.fr, user21@user.fr, user3@user.fr", startTime4,
                            endTime4, new Room(3, "Pegasus")),
                    new

                            Meeting(4, "Réunion 5", "user14@user.fr, user15@user.fr", startTime5,
                            endTime5, new Room(4, "Paintsilvia")),
                    new

                            Meeting(5, "Réunion 6", "user16@user.fr", startTime6,
